...
elseif (strcmp(type,'Quadrilateral'))
    if degree=='1'
    ...
    elseif (strcmp(degree,'Biquadratic'))
    ...
    elseif (strcmp(degree,'Serendipity'))
...
elseif (strcmp(type,'Tetrahedral'))
